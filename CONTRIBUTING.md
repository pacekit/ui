# Contributing to PaceUI GSAP

First off, thank you for considering contributing to PaceUI GSAP! 🎉 We love our community and are excited to see your contributions. These guidelines will help you get started.
...
1.  **Fork the Repository**: Click the 'Fork' button at the top right of the PaceUI GSAP GitHub page.
...
1.  **Push your branch**:
    ...
    ```
2.  **Open a Pull Request**: Go to the PaceUI GSAP repository on GitHub and click "New pull request".
